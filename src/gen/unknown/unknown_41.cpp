...
void bind_unknown_unknown_41(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // asmjit::Logger file: line:28
		...
		cl.def("log", (unsigned int (asmjit::Logger::*)(const class asmjit::String &)) &asmjit::Logger::log, "Logs content of a string `str`.\n\nC++: asmjit::Logger::log(const class asmjit::String &) --> unsigned int", pybind11::arg("str"));
	...
	{ // asmjit::StringLogger file: line:145
		...
		cl.def("content", (class asmjit::String & (asmjit::StringLogger::*)()) &asmjit::StringLogger::content, "Returns the content of the logger as \n\n It can be moved, if desired.\n\nC++: asmjit::StringLogger::content() --> class asmjit::String &", pybind11::return_value_policy::automatic);
