...
void bind_unknown_unknown_44(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // asmjit::x86::Reg file: line:75
		...
		cl.def_static("isOperandGpb", (bool (*)(const struct asmjit::Operand_ &)) &asmjit::x86::Reg::isGpb, "Tests whether the `op` operand is either a low or high 8-bit GPB register.\n\nC++: asmjit::x86::Reg::isGpb(const struct asmjit::Operand_ &) --> bool", pybind11::arg("op"));
		cl.def_static("isOperandGpbLo", (bool (*)(const struct asmjit::Operand_ &)) &asmjit::x86::Reg::isGpbLo, "C++: asmjit::x86::Reg::isGpbLo(const struct asmjit::Operand_ &) --> bool", pybind11::arg("op"));
		cl.def_static("isOperandGpbHi", (bool (*)(const struct asmjit::Operand_ &)) &asmjit::x86::Reg::isGpbHi, "C++: asmjit::x86::Reg::isGpbHi(const struct asmjit::Operand_ &) --> bool", pybind11::arg("op"));
		cl.def_static("isOperandGpw", (bool (*)(const struct asmjit::Operand_ &)) &asmjit::x86::Reg::isGpw, "C++: asmjit::x86::Reg::isGpw(const struct asmjit::Operand_ &) --> bool", pybind11::arg("op"));
		cl.def_static("isOperandGpd", (bool (*)(const struct asmjit::Operand_ &)) &asmjit::x86::Reg::isGpd, "C++: asmjit::x86::Reg::isGpd(const struct asmjit::Operand_ &) --> bool", pybind11::arg("op"));
		cl.def_static("isOperandGpq", (bool (*)(const struct asmjit::Operand_ &)) &asmjit::x86::Reg::isGpq, "C++: asmjit::x86::Reg::isGpq(const struct asmjit::Operand_ &) --> bool", pybind11::arg("op"));
		cl.def_static("isOperandXmm", (bool (*)(const struct asmjit::Operand_ &)) &asmjit::x86::Reg::isXmm, "C++: asmjit::x86::Reg::isXmm(const struct asmjit::Operand_ &) --> bool", pybind11::arg("op"));
		cl.def_static("isOperandYmm", (bool (*)(const struct asmjit::Operand_ &)) &asmjit::x86::Reg::isYmm, "C++: asmjit::x86::Reg::isYmm(const struct asmjit::Operand_ &) --> bool", pybind11::arg("op"));
		cl.def_static("isOperandZmm", (bool (*)(const struct asmjit::Operand_ &)) &asmjit::x86::Reg::isZmm, "C++: asmjit::x86::Reg::isZmm(const struct asmjit::Operand_ &) --> bool", pybind11::arg("op"));
		cl.def_static("isOperandMm", (bool (*)(const struct asmjit::Operand_ &)) &asmjit::x86::Reg::isMm, "C++: asmjit::x86::Reg::isMm(const struct asmjit::Operand_ &) --> bool", pybind11::arg("op"));
		cl.def_static("isOperandKReg", (bool (*)(const struct asmjit::Operand_ &)) &asmjit::x86::Reg::isKReg, "C++: asmjit::x86::Reg::isKReg(const struct asmjit::Operand_ &) --> bool", pybind11::arg("op"));
		cl.def_static("isOperandSReg", (bool (*)(const struct asmjit::Operand_ &)) &asmjit::x86::Reg::isSReg, "C++: asmjit::x86::Reg::isSReg(const struct asmjit::Operand_ &) --> bool", pybind11::arg("op"));
		cl.def_static("isOperandCReg", (bool (*)(const struct asmjit::Operand_ &)) &asmjit::x86::Reg::isCReg, "C++: asmjit::x86::Reg::isCReg(const struct asmjit::Operand_ &) --> bool", pybind11::arg("op"));
		cl.def_static("isOperandDReg", (bool (*)(const struct asmjit::Operand_ &)) &asmjit::x86::Reg::isDReg, "C++: asmjit::x86::Reg::isDReg(const struct asmjit::Operand_ &) --> bool", pybind11::arg("op"));
		cl.def_static("isOperandSt", (bool (*)(const struct asmjit::Operand_ &)) &asmjit::x86::Reg::isSt, "C++: asmjit::x86::Reg::isSt(const struct asmjit::Operand_ &) --> bool", pybind11::arg("op"));
		cl.def_static("isOperandBnd", (bool (*)(const struct asmjit::Operand_ &)) &asmjit::x86::Reg::isBnd, "C++: asmjit::x86::Reg::isBnd(const struct asmjit::Operand_ &) --> bool", pybind11::arg("op"));
		cl.def_static("isOperandTmm", (bool (*)(const struct asmjit::Operand_ &)) &asmjit::x86::Reg::isTmm, "C++: asmjit::x86::Reg::isTmm(const struct asmjit::Operand_ &) --> bool", pybind11::arg("op"));
		cl.def_static("isOperandRip", (bool (*)(const struct asmjit::Operand_ &)) &asmjit::x86::Reg::isRip, "C++: asmjit::x86::Reg::isRip(const struct asmjit::Operand_ &) --> bool", pybind11::arg("op"));
		cl.def_static("isOperandGpb", (bool (*)(const struct asmjit::Operand_ &, unsigned int)) &asmjit::x86::Reg::isGpb, "C++: asmjit::x86::Reg::isGpb(const struct asmjit::Operand_ &, unsigned int) --> bool", pybind11::arg("op"), pybind11::arg("rId"));
		cl.def_static("isOperandGpbLo", (bool (*)(const struct asmjit::Operand_ &, unsigned int)) &asmjit::x86::Reg::isGpbLo, "C++: asmjit::x86::Reg::isGpbLo(const struct asmjit::Operand_ &, unsigned int) --> bool", pybind11::arg("op"), pybind11::arg("rId"));
		cl.def_static("isOperandGpbHi", (bool (*)(const struct asmjit::Operand_ &, unsigned int)) &asmjit::x86::Reg::isGpbHi, "C++: asmjit::x86::Reg::isGpbHi(const struct asmjit::Operand_ &, unsigned int) --> bool", pybind11::arg("op"), pybind11::arg("rId"));
		cl.def_static("isOperandGpw", (bool (*)(const struct asmjit::Operand_ &, unsigned int)) &asmjit::x86::Reg::isGpw, "C++: asmjit::x86::Reg::isGpw(const struct asmjit::Operand_ &, unsigned int) --> bool", pybind11::arg("op"), pybind11::arg("rId"));
		cl.def_static("isOperandGpd", (bool (*)(const struct asmjit::Operand_ &, unsigned int)) &asmjit::x86::Reg::isGpd, "C++: asmjit::x86::Reg::isGpd(const struct asmjit::Operand_ &, unsigned int) --> bool", pybind11::arg("op"), pybind11::arg("rId"));
		cl.def_static("isOperandGpq", (bool (*)(const struct asmjit::Operand_ &, unsigned int)) &asmjit::x86::Reg::isGpq, "C++: asmjit::x86::Reg::isGpq(const struct asmjit::Operand_ &, unsigned int) --> bool", pybind11::arg("op"), pybind11::arg("rId"));
		cl.def_static("isOperandXmm", (bool (*)(const struct asmjit::Operand_ &, unsigned int)) &asmjit::x86::Reg::isXmm, "C++: asmjit::x86::Reg::isXmm(const struct asmjit::Operand_ &, unsigned int) --> bool", pybind11::arg("op"), pybind11::arg("rId"));
		cl.def_static("isOperandYmm", (bool (*)(const struct asmjit::Operand_ &, unsigned int)) &asmjit::x86::Reg::isYmm, "C++: asmjit::x86::Reg::isYmm(const struct asmjit::Operand_ &, unsigned int) --> bool", pybind11::arg("op"), pybind11::arg("rId"));
		cl.def_static("isOperandZmm", (bool (*)(const struct asmjit::Operand_ &, unsigned int)) &asmjit::x86::Reg::isZmm, "C++: asmjit::x86::Reg::isZmm(const struct asmjit::Operand_ &, unsigned int) --> bool", pybind11::arg("op"), pybind11::arg("rId"));
		cl.def_static("isOperandMm", (bool (*)(const struct asmjit::Operand_ &, unsigned int)) &asmjit::x86::Reg::isMm, "C++: asmjit::x86::Reg::isMm(const struct asmjit::Operand_ &, unsigned int) --> bool", pybind11::arg("op"), pybind11::arg("rId"));
		cl.def_static("isOperandKReg", (bool (*)(const struct asmjit::Operand_ &, unsigned int)) &asmjit::x86::Reg::isKReg, "C++: asmjit::x86::Reg::isKReg(const struct asmjit::Operand_ &, unsigned int) --> bool", pybind11::arg("op"), pybind11::arg("rId"));
		cl.def_static("isOperandSReg", (bool (*)(const struct asmjit::Operand_ &, unsigned int)) &asmjit::x86::Reg::isSReg, "C++: asmjit::x86::Reg::isSReg(const struct asmjit::Operand_ &, unsigned int) --> bool", pybind11::arg("op"), pybind11::arg("rId"));
		cl.def_static("isOperandCReg", (bool (*)(const struct asmjit::Operand_ &, unsigned int)) &asmjit::x86::Reg::isCReg, "C++: asmjit::x86::Reg::isCReg(const struct asmjit::Operand_ &, unsigned int) --> bool", pybind11::arg("op"), pybind11::arg("rId"));
		cl.def_static("isOperandDReg", (bool (*)(const struct asmjit::Operand_ &, unsigned int)) &asmjit::x86::Reg::isDReg, "C++: asmjit::x86::Reg::isDReg(const struct asmjit::Operand_ &, unsigned int) --> bool", pybind11::arg("op"), pybind11::arg("rId"));
		cl.def_static("isOperandSt", (bool (*)(const struct asmjit::Operand_ &, unsigned int)) &asmjit::x86::Reg::isSt, "C++: asmjit::x86::Reg::isSt(const struct asmjit::Operand_ &, unsigned int) --> bool", pybind11::arg("op"), pybind11::arg("rId"));
		cl.def_static("isOperandBnd", (bool (*)(const struct asmjit::Operand_ &, unsigned int)) &asmjit::x86::Reg::isBnd, "C++: asmjit::x86::Reg::isBnd(const struct asmjit::Operand_ &, unsigned int) --> bool", pybind11::arg("op"), pybind11::arg("rId"));
		cl.def_static("isOperandTmm", (bool (*)(const struct asmjit::Operand_ &, unsigned int)) &asmjit::x86::Reg::isTmm, "C++: asmjit::x86::Reg::isTmm(const struct asmjit::Operand_ &, unsigned int) --> bool", pybind11::arg("op"), pybind11::arg("rId"));
		cl.def_static("isOperandRip", (bool (*)(const struct asmjit::Operand_ &, unsigned int)) &asmjit::x86::Reg::isRip, "C++: asmjit::x86::Reg::isRip(const struct asmjit::Operand_ &, unsigned int) --> bool", pybind11::arg("op"), pybind11::arg("rId"));
	}
}
