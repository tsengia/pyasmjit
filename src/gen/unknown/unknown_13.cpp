...
void bind_unknown_unknown_13(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // asmjit::BaseReg file: line:901
		...
		cl.def_static("isOperandGp", (bool (*)(const struct asmjit::Operand_ &)) &asmjit::BaseReg::isGp, "Tests whether the `op` operand is a general purpose register.\n\nC++: asmjit::BaseReg::isGp(const struct asmjit::Operand_ &) --> bool", pybind11::arg("op"));
		cl.def_static("isOperandVec", (bool (*)(const struct asmjit::Operand_ &)) &asmjit::BaseReg::isVec, "Tests whether the `op` operand is a vector register.\n\nC++: asmjit::BaseReg::isVec(const struct asmjit::Operand_ &) --> bool", pybind11::arg("op"));
		cl.def_static("isOperandGp", (bool (*)(const struct asmjit::Operand_ &, unsigned int)) &asmjit::BaseReg::isGp, "Tests whether the `op` is a general purpose register of the given `id`.\n\nC++: asmjit::BaseReg::isGp(const struct asmjit::Operand_ &, unsigned int) --> bool", pybind11::arg("op"), pybind11::arg("id"));
		cl.def_static("isOperandVec", (bool (*)(const struct asmjit::Operand_ &, unsigned int)) &asmjit::BaseReg::isVec, "Tests whether the `op` is a vector register of the given `id`.\n\nC++: asmjit::BaseReg::isVec(const struct asmjit::Operand_ &, unsigned int) --> bool", pybind11::arg("op"), pybind11::arg("id"));
	}
